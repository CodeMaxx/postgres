...
DATA(insert OID = 336 (  smergehandler	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 325 "2281" _null_ _null_ _null_ _null_ _null_	smergehandler _null_ _null_ _null_ ));
DESCR("smerge index access method handler");
