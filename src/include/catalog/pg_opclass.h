...
/* smerge */
DATA(insert (	9399	abstime_ops			PGNSP PGUID		7000    702 t 0 ));
DATA(insert (	9399	array_ops			PGNSP PGUID		7001   2277 t 0 ));
DATA(insert (	9399	bit_ops				PGNSP PGUID		7002   1560 t 0 ));
DATA(insert (	9399	bool_ops			PGNSP PGUID		7003     16 t 0 ));
DATA(insert (	9399	bpchar_ops			PGNSP PGUID		7004   1042 t 0 ));
DATA(insert (	9399	bytea_ops			PGNSP PGUID		7005     17 t 0 ));
DATA(insert (	9399	char_ops			PGNSP PGUID		7006     18 t 0 ));
DATA(insert (	9399	cidr_ops			PGNSP PGUID		7009   869 f 0 ));
DATA(insert (	9399	date_ops			PGNSP PGUID		7007   1082 t 0 ));
DATA(insert (	9399	float4_ops			PGNSP PGUID		7009   700 t 0 ));
DATA(insert (	9399	float8_ops			PGNSP PGUID		7009   701 t 0 ));
DATA(insert (	9399	inet_ops			PGNSP PGUID		7010   869 t 0 ));
DATA(insert (	9399	int2_ops			PGNSP PGUID		7010    21 t 0 ));
DATA(insert (	9399	int4_ops			PGNSP PGUID		7010    23 t 0 ));
DATA(insert (	9399	int8_ops			PGNSP PGUID		7010    20 t 0 ));
DATA(insert (	9399	interval_ops		PGNSP PGUID		7011  1186 t 0 ));
DATA(insert (	9399	macaddr_ops			PGNSP PGUID		7012   829 t 0 ));
DATA(insert (	9399	name_ops			PGNSP PGUID		7013    19 t 2275 ));
DATA(insert (	9399	numeric_ops			PGNSP PGUID		7014  1700 t 0 ));
DATA(insert (	9399	oid_ops				PGNSP PGUID		7015    26 t 0 ));
DATA(insert (	9399	oidvector_ops		PGNSP PGUID		7016    30 t 0 ));
DATA(insert (	9399	record_ops			PGNSP PGUID		7017  2249 t 0 ));
DATA(insert (	9399	record_image_ops	PGNSP PGUID		7018  2249 f 0 ));
DATA(insert (	9399	text_ops			PGNSP PGUID		7019    25 t 0 ));
DATA(insert (	9399	time_ops			PGNSP PGUID		7020  1083 t 0 ));
DATA(insert (	9399	timestamptz_ops		PGNSP PGUID		7007   1184 t 0 ));
DATA(insert (	9399	timetz_ops			PGNSP PGUID		7021  1266 t 0 ));
DATA(insert (	9399	varbit_ops			PGNSP PGUID		7022  1562 t 0 ));
DATA(insert (	9399	varchar_ops			PGNSP PGUID		7019    25 f 0 ));
DATA(insert (	9399	timestamp_ops		PGNSP PGUID		7007   1114 t 0 ));
DATA(insert (	9399	text_pattern_ops	PGNSP PGUID		7023    25 f 0 ));
DATA(insert (	9399	varchar_pattern_ops PGNSP PGUID		7023    25 f 0 ));
DATA(insert (	9399	bpchar_pattern_ops	PGNSP PGUID		7024  1042 f 0 ));
DATA(insert (	9399	money_ops			PGNSP PGUID		7025   790 t 0 ));
DATA(insert (	9399	tid_ops				PGNSP PGUID		7026    27 t 0 ));
DATA(insert (	9399	reltime_ops			PGNSP PGUID		7027   703 t 0 ));
DATA(insert (	9399	tinterval_ops		PGNSP PGUID		7028   704 t 0 ));
DATA(insert (	9399	uuid_ops			PGNSP PGUID		7029   2950 t 0 ));
DATA(insert (	9399	pg_lsn_ops			PGNSP PGUID		7030   3220 t 0 ));
DATA(insert (	9399	enum_ops			PGNSP PGUID		7031   3500 t 0 ));
DATA(insert (	9399	tsvector_ops		PGNSP PGUID		7032   3614 t 0 ));
DATA(insert (	9399	tsquery_ops			PGNSP PGUID		7033   3615 t 0 ));
DATA(insert (	9399	range_ops			PGNSP PGUID		7034   3831 t 0 ));
DATA(insert (	9399	jsonb_ops			PGNSP PGUID		7035   3802 t 0 ));
#endif   /* PG_OPCLASS_H */
